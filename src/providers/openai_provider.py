...
class OpenAIProvider(BaseLLMProvider):
    ...
    def find_lightweight_model(self, available_models: List[str]) -> Optional[str]:
        ...
        - mini: gpt-5-mini-2025-08-07, gpt-5-mini, gpt-4.1-mini-2025-04-14, gpt-4.1-mini, gpt-4o-mini-2024-07-18, gpt-4o-mini
        ...
        # 채팅용 모델만 필터링 (text-embedding, tts, dall-e, whisper, codex, audio, realtime, search, image 등 제외)
        excluded_keywords = [
            "embedding",
            "tts",
            "dall-e",
    ...
    def is_available(self) -> bool:
        """사용 가능 여부"""
        return EnvConfig.OPENAI_API_KEY is not None
